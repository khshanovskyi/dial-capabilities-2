...
3. Endpoint: `https://api.githubcopilot.com/mcp/`, Transport protocol: `HTTP`, Authentication: `API Key`. Then provide auth header and token. Token you can generate here 👉 https://github.com/settings/tokens. Then click `Log in` 
...
5. Restart DIAL Core
6. Test it in DIAL Chat 👉 http://localhost:3000/
